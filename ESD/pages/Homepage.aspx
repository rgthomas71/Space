<!DOCTYPE html>
<html data-ng-app="SMARTApp3" xmlns:mso="urn:schemas-microsoft-com:office:office" xmlns:msdt="uuid:C2F41010-65B3-11d1-A29F-00AA00C14882">
...
<meta charset="utf-8">
    ...
    <link type="text/css" rel="stylesheet" href="/teams/SMD/ESD/SiteAssets/SiteCode/ESD/AdminManagementConsole/style.css" />
    ...
    <link type="text/css" rel="stylesheet" href="/teams/SMD/SiteAssets/Libraries/bootstrap-4.1.3/js/bootstrap.min.css" />
	...
	<script src="/teams/SMD/SiteAssets/Libraries/popper.min.js" type="text/javascript"></script>
	<script src="/teams/SMD/SiteAssets/Libraries/bootbox.all.min.js" type="text/javascript"></script>
	...
	<!--<script src="/teams/SMD/SiteAssets/Libraries/sp-peoplepicker.js"></script>-->
	 <!-- App -->
    <script src="/teams/SMD/SiteAssets/SiteCode/Homepage/SMART_App3.js"></script>
    ...
    <!--Specific Factory-->
    <!-- <script src="/teams/SMD/ESD/SiteAssets/SiteCode/ESD/AdminManagementConsole/Factories/SMART_Factory.js"></script> -->


    <!-- controllers -->
    <script src="/teams/SMD/SiteAssets/SiteCode/Homepage/HomepageController.js"></script>
	<!-- <<script src="/teams/SMD/ESD/SiteAssets/SiteCode/HAL/GlobalHALComponents.js"></script> -->
...
<body class="halBody" style="overflow: scroll;">
	...
	<div id="viewContainer" style="overflow-x: unset; height: auto;" ng-view="">
	</div>
</div>
</body>
<footer>
